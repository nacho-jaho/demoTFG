    ...
    <body>
        <div id="cuerpo">
			...
			<!-- colocar las fotos y moverlas de manera circular -->
				...
				<center>
					<div class="slideshow">
						<img style="border: solid 10px #E84831;" src="fotos/contacto.jpg" width="800" height="200"/>
						<img style="border: solid 10px #E84831;" src="fotos/contacto1.jpg" width="800" height="200"/> 
						<img style="border: solid 10px #E84831;" src="fotos/contacto2.jpg" width="800" height="200"/>
						<img style="border: solid 10px #E84831;" src="fotos/contacto3.jpg" width="800" height="200"/>
						<img style="border: solid 10px #E84831;" src="fotos/contacto4.jpg" width="800" height="200"/>
					</div>
				</center>
			</div>
			...
			<div id ="contenido">
				...
				<tr>
					...
					<td rowspan="2" width ="50%">
						...
						Asunto</br>
						<input type="text" name="asunto" class="texto"><font color= #E84831>*</font></br></br>		
						Mensaje</br>
						<textarea name="mensaje" class="mensaje"></textarea><font color= #E84831>*</font></br></br>		
